...
\end{frame}
\begin{frame}[label={sec:org8f018bf}]{BERT - что это?}
...
\begin{frame}[label={sec:orgfffa4d4}]{Маскирование: простые решения}
\begin{enumerate}
...
\begin{frame}[label={sec:org694d787}]{Маскирование: победившие решения}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgae48bbd},fragile]{Маскирование: наше решение}
 \begin{itemize}
...
\begin{frame}[label={sec:orgd378c82}]{командная работа}
\begin{itemize}
...
\begin{frame}[label={sec:orge7c144c}]{Допущенные ошибки}
\begin{itemize}
...
\begin{frame}[label={sec:org406c98f}]{Вынесенные уроки}
\begin{itemize}
