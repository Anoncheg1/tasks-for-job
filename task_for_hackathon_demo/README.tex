...
\end{frame}
\begin{frame}[label={sec:org272171a}]{BERT - что это?}
...
\begin{frame}[label={sec:org75787aa}]{Маскирование: простые решения}
\begin{enumerate}
...
\begin{frame}[label={sec:orgc94f273}]{Маскирование: победившие решения}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgcac6b83},fragile]{Маскирование: наше решение}
 \begin{itemize}
...
\begin{frame}[label={sec:org4e5f260}]{командная работа}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org095f3ad}]{Допущенные ошибки}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb5f34da}]{Вынесенные уроки}
\begin{itemize}
